...
class _MyWidgetState extends State<Page4_2> {
  int redBag = 7500000;
  int tsCount = 0;
  ...
  Widget build(BuildContext context) {
    final TextEditingController _controllerTimes = new TextEditingController(text: '10');
    final TextEditingController _controllerLevel = new TextEditingController(text: '1');
    final TextEditingController _controllerValueOfMtp = new TextEditingController(text: '90');
    final TextEditingController _controllerValueOfAtp = new TextEditingController(text: '120');
    final TextEditingController _controllerValueOfMatp = new TextEditingController(text: '120');
    return Align(
